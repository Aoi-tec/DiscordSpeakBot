...
class Runtime:
    ...
    def submit_preview(self, text, settings):
        ...
        if self.preview_pending or any(v["state"] == "running" for v in self.operations.values()):
            ...
            while not self.stopping.is_set():
                ...
                if not generating and self.engine_ready:
                    ...
                    if job:
                        ...
                        job, self.preview_pending = self.preview_pending, None
